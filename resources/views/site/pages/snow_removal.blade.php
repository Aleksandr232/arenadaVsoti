...
@section('title', 'Уборка снега, сосулек и наледи с крыш в Казани «Аренда высоты»')
@section('description', 'Предлагаем уборку снега с крыш разово или по абонентскому обслуживанию на определенный период времени «Аренда высоты»')
        ...
        <div class="sr-advantages my-container">
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="{{ asset('frontend/img/snow-removal/sr-1.svg') }}" width="50" height="50" alt="">
                </div>
                <h2>От заявки до старта работы - не более 24 часов</h2>
            </div>
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="{{ asset('frontend/img/snow-removal/sr-2.svg') }}" width="50" height="50" alt="">
                </div>
                <h2>Несем материальную ответственность за сохранность кровли</h2>
            </div>
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="{{ asset('frontend/img/snow-removal/sr-3.svg') }}" width="50" height="50" alt="">
                </div>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/img/snow-removal/sr-price-1.jpg') }}" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/img/snow-removal/sr-price-2.jpg') }}" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/img/snow-removal/sr-price-3.jpg') }}" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/img/snow-removal/sr-price-4.jpg') }}" width="280" height="280" alt="">
                        </picture>

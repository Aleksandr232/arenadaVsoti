    ...
    <div class="opa-block_two">
        ...
        <div class="op-additional__card">
            <a href="<?php echo e(route('gallery')); ?>">
                <picture>
                    <source type="image/webp" srcset="<?php echo e(asset('frontend/img/main/gallery.webp')); ?>">
                    <img src="<?php echo e(asset('frontend/img/main/gallery.jpg')); ?>" width="320" height="350" alt="">
                </picture>
            </a>
            <div class="opa-card__info">
                <h2>Наша галерея</h2>
                <a href="<?php echo e(route('gallery')); ?>">Подробнее →</a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /Users/arturzakirov/Documents/MyFiles/mySites/height-rent/resources/views/site/inc/products_extended.blade.php ENDPATH**/ ?>
<div class="modal-window">
    <div class="modal">
        <form action="<?php echo e(route('send')); ?>" method="post" autocomplete="on">
            ...
            <label>
                <input type="tel" name="phone" class="input-name__phone mask-phone" id="tel" placeholder="Введите номер телефона" required>
            </label>
            <div class="checkbox-wrap">
                ...
                <div class="checkbox-content">
                    <p>Нажимая на кнопку «Оставить заявку», вы даёте согласие на <a href="<?php echo e(asset('frontend/doc/privacy.pdf')); ?>" rel="nofollow" target="_blank" class="modal-doc">обработку своих персональных данных</a></p>
                </div>
            </div>
...
<?php /**PATH /Users/arturzakirov/Documents/MyFiles/MySites/height-rent/resources/views/site/inc/modal_window.blade.php ENDPATH**/ ?>
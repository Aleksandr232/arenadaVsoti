        ...
        <div class="card-body register-card-body">
            ...
            <form action="<?php echo e(route('register.store')); ?>" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="name" class="form-control" placeholder="Введите имя" value="<?php echo e(old('name')); ?>">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control" placeholder="Email" value="<?php echo e(old('name')); ?>">
                    <div class="input-group-append">
                        <div class="input-group-text">
...
<?php /**PATH /Applications/MAMP/htdocs/height-rent/resources/views/user/create.blade.php ENDPATH**/ ?>
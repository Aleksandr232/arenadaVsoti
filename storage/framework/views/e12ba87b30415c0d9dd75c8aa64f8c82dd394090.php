    ...
    <div id="snow-removal">
        ...
        <div class="sr-callToAction">
            <div class="srcTA-title">
                <h2>Окончательная цена расчитывается индивидуально и зависит от:</h2>
            </div>
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/arturzakirov/Documents/MyFiles/mySites/height-rent/resources/views/site/pages/snow_removal.blade.php ENDPATH**/ ?>
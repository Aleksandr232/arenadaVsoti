...
<?php $__env->startSection('keywords', 'вышка тура аренда, вышка тура авито, вышка тура, вышка тура казань, вышка тура строительная, вышка тура 2 2, вышка тура передвижная, вышка тура +на колесах, вышка тура аренда казань'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section id="price-towers__tour">
        <div class="price-towers__tour my-container">
            ...
            <div class="ptt-image">
                <picture>
                    <source type="image/webp" srcset="<?php echo e(asset('frontend/img/tour-towers/towers-tour-price.webp')); ?>">
                    <img src="<?php echo e(asset('frontend/img/tour-towers/towers-tour-price.jpg')); ?>" width="720" height="1280" alt="">
                </picture>
            </div>
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/user76834/data/www/xn--80aagge2ckkol0hd.xn--p1ai/resources/views/site/pages/towers_tour.blade.php ENDPATH**/ ?>
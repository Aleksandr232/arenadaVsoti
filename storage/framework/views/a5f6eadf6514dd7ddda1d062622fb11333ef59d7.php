<div class="op-additional">
    ...
    <div class="opa-block_two">
        ...
        <div class="op-additional__card">
            <a href="<?php echo e(route('snow_removal')); ?>">
                <picture>
            ...
            <div class="opa-card__info">
                ...
                <a href="<?php echo e(route('snow_removal')); ?>">Подробнее →</a>
...
<?php /**PATH /Users/arturzakirov/Documents/MyFiles/MySites/height-rent/resources/views/site/inc/products_additional.blade.php ENDPATH**/ ?>
        ...
        <div class="scaffolding-price my-container">
            ...
            <div class="sp-card__wrap">
                <div class="sp-card">
                    ...
                    <button class="sp-card__btn sp-card__btn__one btn" data-btn="Заявка на аренду ЛСПР-200 <100м2">Арендовать</button>
                </div>
                <div class="sp-card">
                    ...
                    <button class="sp-card__btn sp-card__btn__two btn" data-btn="Заявка на аренду ЛСПР-200 100-200м2">Арендовать</button>
                </div>
                <div class="sp-card">
                    ...
                    <button class="sp-card__btn sp-card__btn__three btn" data-btn="Заявка на аренду ЛСПР-200 200-300м2">Арендовать</button>
                </div>
                <div class="sp-card">
                    ...
                    <div class="sp-card__price sp-card__price__four">
                        <h4 class="sp-card__opacity__title">По договоренности</h4>
                        <p class="sp-card__opacity">Стоимость указана за кв.м в месяц</p>
                        <table class="sp-card__opacity">
                            <tr>
                                <td>без настилов</td>
                                <td class="sp-price__cost"><span>-</span> &#8381;</td>
                            </tr>
                            <tr>
                                <td>с настилами на 1 ярус</td>
                                <td class="sp-price__cost"><span>-</span> &#8381;</td>
                    ...
                    <button class="sp-card__btn sp-card__btn__four btn" data-btn="Заявка на аренду ЛСПР-200 >300м2">Договориться</button>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OpenServer\domains\height-rent.loc\resources\views/site/pages/scaffolding.blade.php ENDPATH**/ ?>
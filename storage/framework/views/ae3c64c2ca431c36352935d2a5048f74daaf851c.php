<?php $__env->startSection('title', 'Уборка снега, сосулек и наледи с крыш в Казани «Аренда высоты»'); ?>
<?php $__env->startSection('description', 'Предлагаем уборку снега с крыш разово или по абонентскому обслуживанию на определенный период времени «Аренда высоты»'); ?>
<?php $__env->startSection('keywords', 'уборка снега с крыш Казань, уборка снега с крыш цена, сброс снега с крыш, чистка снега с крыш, чистка кровли от снега, уборка снега с кровли, очистка кровли от снега, уборка сосулек и наледи с крыш'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="sr-advantages my-container">
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="<?php echo e(asset('frontend/img/snow-removal/sr-1.svg')); ?>" width="50" height="50" alt="">
                </div>
                <h2>От заявки до старта работы - не более 24 часов</h2>
            </div>
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="<?php echo e(asset('frontend/img/snow-removal/sr-2.svg')); ?>" width="50" height="50" alt="">
                </div>
                <h2>Несем материальную ответственность за сохранность кровли</h2>
            </div>
            <div class="sra-card">
                <div class="sra-card__icon">
                    <img src="<?php echo e(asset('frontend/img/snow-removal/sr-3.svg')); ?>" width="50" height="50" alt="">
                </div>
            ...
            <div class="sr-price my-container">
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            <source type="image/webp" srcset="<?php echo e(asset('frontend/img/snow-removal/sr-price-1.webp')); ?>">
                            <img src="<?php echo e(asset('frontend/img/snow-removal/sr-price-1.jpg')); ?>" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            <source type="image/webp" srcset="<?php echo e(asset('frontend/img/snow-removal/sr-price-2.webp')); ?>">
                            <img src="<?php echo e(asset('frontend/img/snow-removal/sr-price-2.jpg')); ?>" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            <source type="image/webp" srcset="<?php echo e(asset('frontend/img/snow-removal/sr-price-3.webp')); ?>">
                            <img src="<?php echo e(asset('frontend/img/snow-removal/sr-price-3.jpg')); ?>" width="280" height="280" alt="">
                        </picture>
                ...
                <div class="sr-price__card">
                    ...
                    <div class="srp-card__content">
                        <picture>
                            <source type="image/webp" srcset="<?php echo e(asset('frontend/img/snow-removal/sr-price-4.webp')); ?>">
                            <img src="<?php echo e(asset('frontend/img/snow-removal/sr-price-4.jpg')); ?>" width="280" height="280" alt="">
                        </picture>
                        <div class="srp-insert__info">
                            <h3>Минимум 4 часа + доставка трактора</h3>
                        </div>
                        <h2>Уборка снега минитрактором</h2>
                        <p><span>1200</span>&#8381; / в час</p>
        ...
        <div class="sr-callToAction">
            ...
            <div class="srcTA-container my-container">
                ...
                <div class="srcTA-form">
                    ...
                    <form action="<?php echo e(route('send')); ?>" method="post" autocomplete="on">
                        <?php echo csrf_field(); ?>
                        <label>
                        ...
                        <div class="srcTAf-confirm">
                            <p>Нажимая на кнопку «Вызвать оценщика», вы даёте согласие на <a href="<?php echo e(asset('frontend/doc/privacy.pdf')); ?>" rel="nofollow" target="_blank" class="modal-doc">обработку своих персональных данных</a></p>
                        </div>
    ...
    <section id="towers-tour__recommendations">
        ...
        <div class="tt-recommendations my-container">
            ...
            <?php echo $__env->make('site.inc.products_extended', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </section>
    <!-- include our-products end -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/user76834/data/www/xn--80aagge2ckkol0hd.xn--p1ai/resources/views/site/pages/snow_removal.blade.php ENDPATH**/ ?>